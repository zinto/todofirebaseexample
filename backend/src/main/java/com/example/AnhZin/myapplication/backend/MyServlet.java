package com.example.AnhZin.myapplication.backend;
...
/**
 * Created by AnhZin on 8/16/2016.
 */
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.example.AnhZin.myapplication.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Firebase firebase = new Firebase("https://todo-9927a.firebaseio.com/todoItems");
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("nagger@todoengineexample.appspotmail.com",
                            "Todo Nagger"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("[tkposteam@gmail.com", "Recipient"));
